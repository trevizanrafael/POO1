...
public class TstArms{
	public static void main(String args[]){
        ...
        String proa1 = Leitura.entDados("Qual o nome do proprietário:");
        r1.getPessoa().setNome(proa1);

        do{
            String cpfa1 = Leitura.entDados("CPF do proprietário:");
            ver = true;
            try{
                r1.getPessoa().setCpf(Integer.parseInt(cpfa1));
            } catch(NumberFormatException e){
                System.out.println("Digite apenas numerais.");
                ver = false;
            }
