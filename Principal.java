...
public class Principal{
	public static void main(String args[]){
        ...
        System.out.println("CPF do proprietário: " + (p1.getPessoa().getCpf()));
        System.out.print(("\n\n\n\n\n"));
        ...
        System.out.println("CPF do proprietário: " + (r1.getPessoa().getCpf()));
        System.out.println("\n\n\n\n");
        ...
        System.out.println("CPF do proprietário: " + (e1.getPessoa().getCpf()));
        System.out.println("\n\n\n\n");
	}
}
